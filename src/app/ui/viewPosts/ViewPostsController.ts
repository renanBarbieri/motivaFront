...
@Injectable()
export default class ViewPostsController extends LoggedPageController {
  ...
  getPosts(responseHandler: PostsOfTopicsInterestOutputBoundary, topics: Map<number, string>) {
